...
public class BPJSLoginStep extends Steps {
    ...
    public void inquiry (String customerNumber, String productId, String paymentPeriod, String rescode, String pesan) {
        Map<String, Object> reqBody = new HashMap<>();
        ...
        SerenityRest
                .given()
                    ...
                    .body(reqBody)
                .when()
                    .post(endPoint.inquiryBPJS);

        SerenityRest
                .then()
                    .statusCode(200)
                    .body(matchesJsonSchemaInClasspath("JSONSchema/BPJSLogin/inquirySukses.json"));
    ...
    public void addCart (String customerNumber, String productId, String type, String rescode, String pesan){
        ...
        SerenityRest
                .then()
                    .statusCode(200)
                    .body(matchesJsonSchemaInClasspath("JSONSchema/BPJSLogin/addCartSukses.json"));
    ...
    public void selectPayment (String payment, String rescode, String pesan){
        ...
        SerenityRest
                .then()
                    .statusCode(200)
                    .body(matchesJsonSchemaInClasspath("JSONSchema/BPJSLogin/selectPaymentSukses.json"));
    ...
    public void prosesPembayaran (String payment, String cekCC, String rescode, String pesan){
        ...
        if (cekCC.equals("no")){
            SerenityRest
                    .then()
                    .statusCode(200)
                    .body(matchesJsonSchemaInClasspath("JSONSchema/BPJSLogin/prosesPembayaranSukses.json"));
            ...
            SerenityRest
                    .then()
                        .statusCode(200)
                        .body(matchesJsonSchemaInClasspath("JSONSchema/BPJSLogin/prosesPembayaranCCSukses.json"));
    ...
    public void inquiryGagal (String customerNumber, String productId, String paymentPeriod) {
        System.out.println(paymentPeriod);
        Map<String, Object> reqBody = new HashMap<>();
        reqBody.put("customer_number", customerNumber);
        reqBody.put("product_id", productId);
        reqBody.put("payment_period", paymentPeriod);
    ...
    public void validateInquiryGagal(String rescode, String pesan1, String pesan2) {
        SerenityRest
                .then()
                .statusCode(200)
                .body(matchesJsonSchemaInClasspath("JSONSchema/BPJSLogin/inquiryGagal.json"));

        if (rescode.equals("00")) {
            String resCodeActual = SerenityRest.then().extract().path("rescode");
            String pesanActual = SerenityRest.then().extract().path("data");

            Assert.assertTrue(resCodeActual.equals(rescode));
            Assert.assertTrue(pesanActual.equals(pesan2));
        }
            ...
            Assert.assertTrue(resCodeActual.equals(rescode));
            Assert.assertTrue(pesanActual.equals(pesan1));
        }
    }
    ...
    public void validateCompletePembayaranGagal(String rescode, String pesan){
        SerenityRest
                .then()
                    .statusCode(200)
                    .body(matchesJsonSchemaInClasspath("JSONSchema/BPJSLogin/completePembayaranGagal.json"));
